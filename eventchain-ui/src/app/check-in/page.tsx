    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="border-b bg-card">
        <div className="container mx-auto px-4 py-4">
          <h1 className="text-2xl font-bold">Event Check-in Portal</h1>
                ...
                <div className="text-center">
                  ...
                  {isLoadingTickets ? (
                    <p className="text-sm text-muted-foreground mb-4">
                      Checking your tickets and permissions...
                    </p>
                  ) : (
                    <div className="space-y-2 mb-4">
                      ...
                      {selectedEventData?.creator === address ? (
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground mt-2">
                            Only the event creator can currently perform
                            check-ins due to smart contract restrictions
                          </p>
                        </div>
                      )}
                    </div>
